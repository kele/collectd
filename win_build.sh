...
./build.sh
./configure --prefix="C:/opt" --disable-all-plugins CFLAGS="-Drestrict=__restrict -I${CURL_DIR}/include -I$GNULIB_DIR" LDFLAGS="-L$GNULIB_DIR -L${CURL_DIR}/bin" LIBS="-lgnu" --host="mingw32" \
    --enable-logfile \
    --enable-write_http
