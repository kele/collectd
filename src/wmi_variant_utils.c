...
{
    int i;
    for (i = 0; i < sizeof (variant_unsigned_integer_types) / sizeof (*variant_unsigned_integer_types); i++)
...
{
    int i;
    for (i = 0; i < sizeof (variant_signed_integer_types) / sizeof (*variant_signed_integer_types); i++)
